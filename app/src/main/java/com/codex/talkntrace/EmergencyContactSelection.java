    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                {
                    startActivity(new Intent(EmergencyContactSelection.this,Google_Login.class));
                }
                else
                {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mDatabaseTrustedContacts.child(no).child("1").child("msg").setValue("Emergency Message");
                mDatabaseTrustedContacts.child(no).child("2").child("msg").setValue("Emergency Message");
                mDatabaseTrustedContacts.child(no).child("3").child("msg").setValue("Emergency Message");
                Intent intent = new Intent(EmergencyContactSelection.this,MainActivity.class);
       ...
       /* mCardView.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        //Intent i = new Intent(EmergencyContactSelection.this,EditEmergencyMessage.class);
                        //i.putExtra("num1",no);
                        //startActivity(i);
                    }
                }
